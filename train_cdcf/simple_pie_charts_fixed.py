...
class SimplePieChartAnalyzer:
    ...
    def plot_client_totals(self, save_path=None):
        ...
        for client_id in range(self.num_clients):
            ...
            # Use fold 0 to get the total train+val pool for this client
            ...
            # Create pie chart for train+val pool (the actual data distribution for this client)
            ...
            for fold_id in range(self.num_folds):
                ...
                if fold_id in self.split_data[client_id]:
                    ...
                    if total_samples > 0:
                        ...
                        ax.set_title(f'Client {client_id}, Fold {fold_id}', fontweight='bold', fontsize=10)
                        ...
                        ax.set_title(f'Client {client_id}, Fold {fold_id}', fontsize=10)
                else:
                    ax.text(0.5, 0.5, 'No Data', ha='center', va='center', 
                           transform=ax.transAxes, fontsize=10)
                    ax.set_title(f'Client {client_id}, Fold {fold_id}', fontsize=10)
