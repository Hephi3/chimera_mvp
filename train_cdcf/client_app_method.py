...
from utils.core_utils_simul_method import test, train, validate
...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        prototype: Prototype = Prototype.from_data(features_list)#, plot=True)
        ...
        return (
            ...
            len(train_data),
            {"train_loss": train_loss, "f1": f1, "prototype": prototype.serialize()},
        )
