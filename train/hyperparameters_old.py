...
def get_hyperparameters():
    ...
    parser.add_argument('--num_clients', type=int, default=1, help='number of clients (default: 1)')
    parser.add_argument('--num_rounds', type=int, default=1, help='number of federated learning rounds (default: 1)')
    parser.add_argument('--phase_length', type=int, default=15, help='number of epochs per phase (default: 15)')
    parser.add_argument('--es_patience', type=int, default=5, help='early stopping patience (default: 5)')
    parser.add_argument('--es_stop_epoch', type=int, default=40, help='minimum number of epochs before early stopping can occur (default: 40)')
