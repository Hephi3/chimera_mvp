...
def load_data(partition_id, args):
    ...
    val_datasets = []
    test_datasets = []
    assert args.folds == 5, "Only 5-fold splits are supported in this implementation."
    # Normal dataset:
    ...
    #     raise ValueError("Invalid dataset configuration")
        # train_dataset, val_dataset, test_dataset = client_dataset.return_splits(csv_path = '{}/splits_{}.csv'.format(args.split_dir, partition_id + args.use_split_k))
    ...
    if args.num_stages == 2:
        ...
        # if args.folds > 1:
        train_dataset, val_dataset, test_dataset = client_dataset.return_splits(csv_path = '{}/splits_{}_{}_{}.csv'.format(args.split_dir, partition_id + args.use_split_k, args.fold, 1))
        # else:
        # train_dataset, val_dataset, test_dataset = client_dataset.return_splits(csv_path = '{}/splits_{}_{}.csv'.format(args.split_dir, partition_id + args.use_split_k, 1))
        train_datasets.append(train_dataset)
        val_datasets.append(val_dataset)
        test_datasets.append(test_dataset)
