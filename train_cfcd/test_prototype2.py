...
def plot_prototype_test(samples_c0, samples_c1, samples_c2):
    ...
    print("Client 0 Prototype:")
    proto_c0.print_info()
    print("Client 1 Prototype:")
    proto_c1.print_info()
    print("Client 2 Prototype:")
    proto_c2.print_info()
    ...
    proto_c2.print_info()
    proto_global.print_info()
    print(proto_global.distance_prototype(proto_c0),
        proto_global.distance_prototype(proto_c1),
        proto_global.distance_prototype(proto_c2))
...
if __name__ == "__main__":
    ...
    dir = "/gris/gris-f/homelv/phempel/masterthesis/MM_flower/train_cfcd/results/del_s1/Fold0/"
    samples = []
    for i in [0,1,2]:
        data = np.load(f"{dir}/debug_features_client_{i}_round_1.npz")
    ...
    plot_prototype_test(np.array(samples[0]).squeeze(1), np.array(samples[1]).squeeze(1), np.array(samples[2]).squeeze(1))