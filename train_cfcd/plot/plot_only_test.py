...
def plot_test_metrics_comparison(experiment_groups: dict, submodel: str = 'MM',
    ...
    for group_name in all_group_stats.keys():
        if '_f1_stage_0' in all_group_stats[group_name] and '_f1_stage_1' in all_group_stats[group_name]:
            ...
            # print("MIDPOINT:", midpoint, all_rounds_sorted)
    ...
    for i, (base_metric, title) in enumerate(test_metrics.items()):
        ...
        if stage_transition_round is not None:
    ...
    # last_ax = axs[num_metrics - 1]
    # last_ax.legend(handles=legend_handles, labels=legend_labels, bbox_to_anchor=(1.05,1), loc='upper left', fontsize=10, frameon=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Test Metrics Comparison')
    ...
    plot_test_metrics_comparison(experiment_groups, args.submodel, show_std, args.folds, args.name)
