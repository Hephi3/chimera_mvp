    ...
    for client_id in [0,1,2]:
        ...
        for fold_id in range(num_folds):
            ...
            for stage in [0,1]:
                ...
                assert os.path.exists(split_file), f"File {split_file} not found."
            ...
            output_file = os.path.join(output_dir, f"splits_{client_id}_{fold_id}.csv")
...
def main():
    ...
    for i in range(1, 6):
        ...
        output_dir = os.path.join(base_dir, f"chimera_3_5_2_0.2_0.5_0.5_1_stage_{i}")
