...
if __name__ == "__main__":
    ...
    create_csv_split(splits, name=f"chimera_{num_clients}_{folds}_{stages}_{test_p}_{seed}_balanced_{brs3_balances[0]}_{brs3_balances[1]}_nocd", num_clients=num_clients, num_folds=folds, num_stages=stages, outputs_dir=output_dir)
