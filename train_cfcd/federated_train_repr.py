...
from server_app_repr import server_config
from client_app_repprotots import client_config
...
def run_experiment(args):
    ...
    # for i in [0,2,3,4]:
        # if "sp4" in args.exp_code and args.seed == 3:
        #     if i < 3:
